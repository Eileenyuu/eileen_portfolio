  ...
  return (
    ...
    >
      ...
      >
        ...
        projects showcasing my skills in builing AI-powered web applications.
      </motion.p>
      ...
      <motion.div
        ...
        className="grid grid-cols-(--auto-grid-cols) my-10 gap-6 dark:text-black"
      >
        {workData.map((project, index) => (
          ...
          >
            ...
            >
              <div
                className="bg-white/70 w-10/12 rounded-md absolute bottom-5 left-1/2 -translate-x-1/2 py-3 px-5 
            flex items-center justify-between duration-500 group-hover:bottom-7"
              >
                <div>
                  <h2 className="font-outfit font-semibold">{project.title}</h2>
      ...
      {/* <motion.a
       ...
       my-20 hover:bg-light-hover duration-500 dark:text-white dark:border-white/50 
